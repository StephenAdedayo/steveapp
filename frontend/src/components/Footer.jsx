  ...
  return (
    ...
    <footer className=' flex flex-col md:flex-row gap-10 py-5 my-20'>
      ...
      <div className='space-y-5 flex-[70%] gap-10'>
        ...
        <p className='w-full md:w-[500px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, blanditiis. Commodi ex beatae, alias unde asperiores nesciunt dignissimos esse eligendi.</p>
      </div>
