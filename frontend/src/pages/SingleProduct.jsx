...
const SingleProduct = () => {
  const { id } = useParams();
  const { products, currency, addProduct } = useContext(ShopContext);
  ...
  return productData ? (
    <div className="w-full transition-opacity opacity-100 duration-300 delay-75 ">
      <div className="flex flex-col sm:flex-row gap-8">
        ...
        <div className="flex-[40%] space-y-5">
          ...
          <button
            onClick={() => addProduct(productData._id, size)}
          ...
          <p className="text-gray-500">
            ...
            Eash return and exchange policy within 7 days
          </p>
        </div>
      </div>
      ...
      <div className="my-20">
        <div className="flex">
          <p className="border border-gray-300 px-6 text-[14px] font-bold py-2">
            Description
          </p>
          <p className="border border-gray-300 px-6 text-[14px] py-2">
            Reviews(122)
          </p>
        </div>
